...
CONTRACT ARC20 : public Contract {
 public:
  ...
  CONST u128 GetTotalSupply() { return TotalSupply(); }
  ...
  CONST u128 BalanceOf(const Address &owner) {
    return GetBalance(owner);
  }

  CONST u128 Allowance(const Address &owner, const Address &spender) {
 ...
 public:
  ACTION bool Transfer(const Address &to, u128 value) {
  ...
  ACTION bool Approve(const Address &spender, u128 value) {
    Address sender = platon_caller();
